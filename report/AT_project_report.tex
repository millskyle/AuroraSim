...
\fancyhead[C]{Simulating the Aurora $\cdot$ Fall 2015 $\cdot$ MCSC 6280} % Custom header text
...
\title{\vspace{-15mm}\fontsize{20pt}{10pt}\selectfont\textbf{Simulating the Aurora}} % Article title
